                            ...
                            if (datas['usia'] < 18) {
                                ...
                                for (var key in dl) {
                                    if (dl.hasOwnProperty(key)) {
                                        datalist += '<a class="product-sec waves-effect waves-ripple animated fadein" href="javascript:fade(\'chat-group-peer.html?action=read&chatid=' + dl[key]["id"] + '&userid=' + localStorage.userid + '\')"><strong><i class="fal fa-users"></i>  ' + dl[key]["nama"] + '</strong> <i class="fal fa-arrow-right right"></i></a>';

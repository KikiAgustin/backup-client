	...
	$.ajax({
		...
		success: function(data){
			...
			if(data['status']=="OK")
			{
				...
				datalist += '<div class="blog-image"><img src="' + data['detailgambar'] + '" alt="" /></div> <div class="tabs"><div class="tab tab-active" onClick="javascript:fade(\'health-read.html?id='+id+'\');">Profile</div><div class="tab" onClick="javascript:fade(\'belivoucher.html?id='+id+'\');">Beli Voucher</div></div>';

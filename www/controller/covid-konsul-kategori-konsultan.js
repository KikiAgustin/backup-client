$(document).ready(function () {
    ...
    function load_country_data(limit, start) {
        var urls = base_url+"index.php/konsultasi/konsultan/" + secid + "/" + subid + "/" + start + "/" + limit + "/" + localStorage.userid + "/?callback=?";
        $.ajax({
            type: "POST",
            url: urls,
            crossDomain: true,
                            ...
                            if (datas['status'] == "OK") {
                                ...
                                if (datas['verification'] > 0 && datas['verification_until'] >= dt) {
                                    ...
                                    if (datas['selfie_'] === "" || datas['ktp_'] === "" || datas['sktm_'] === "") {
                                        ...
                                        verification += '<strong>Maaf permintaan anda tidak disetujui, karena ada beberapa data yang tidak dikirim/ data yang dikirim tidak sesuai </strong>';
                                        verification += '<br><br>';
                                    } else {

...
$(document).ready(function () {
    ...
    $("#kirim").click(function () {
        ...
        if (isimage == "1") {
            ...
            ft.upload(imageURI, encodeURI("https://www.dfunstation.com/api4/android/index.php/member/gantiavatar/ktp/" + localStorage.userid + "/" + imageURI + "/?callback=?"), win, fail, options);
        }

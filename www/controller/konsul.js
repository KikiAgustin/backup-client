$(document).ready(function () {
    ...
    function load_country_data(limit, start) {
        var urls = base_url + "index.php/konsultasi/konsultan_berbayar/0/0/" + start + "/" + limit + "/" + localStorage.userid + "/?callback=?";
...
function reset() {
    ...
    var lastid = "";
    var urls = "https://www.dfunstation.com/api4/android/index.php/konsultasi/konsultan_berbayar/0/0/" + start + "/" + limit + "/" + localStorage.userid + "/?callback=?";
    $.ajax({
        type: "POST",
        url: urls,
        crossDomain: true,
